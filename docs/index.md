...
!!! info
    ...
    **Source Code Repository:** [https://github.com/mvaldron-rhdh/chatbot-test-app-50](https://github.com/mvaldron-rhdh/chatbot-test-app-50)

    **GitOps Repository:** [https://github.com/mvaldron-rhdh/chatbot-test-app-50-gitops](https://github.com/mvaldron-rhdh/chatbot-test-app-50-gitops)

# **Usage**

To access the chatbot-test-app-50 application that was deployed using the Software Template, complete the following instructions:
